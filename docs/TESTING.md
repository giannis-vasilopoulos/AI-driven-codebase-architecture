...
- REST: MSW (Mock Service Worker) handlers, colocated under **tests**/mocks.
...
2. `pnpm lint` passes
3. `pnpm test` passes, including new tests for new logic
...
deterministically via `pnpm lint`. Keep this file about test strategy and coverage
